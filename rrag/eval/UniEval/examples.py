...
def unieval_summary(src_list, ref_list, output_list):
...
def unieval_dialogue(src_list, context_list, output_list):
    task = 'dialogue'
...
def unieval_fact(src_list, output_list):
    task = 'fact'

    """
    src_list  gt
    
    output_list model 输出
